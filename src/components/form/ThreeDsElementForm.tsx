...
import ThreeDsElementsCallout from '../ecommerce/ThreeDsElementsCallout';
import { ErrorMessage } from 'formik';
import { RefObject } from 'react';
import PublicSquareTypes from '@publicsquare/elements-react/types';

export default function ThreeDsElementForm({
  formik,
  ref,
}: {
  formik: any;
  ...
  return (
    <div className="mt-6 grid grid-cols-4 gap-x-4 gap-y-6">
      ...
      <div className="relative col-span-4">
        ...
        >
          <CardElement ref={ref} id="three-ds-element" />
        </div>
        <ErrorMessage name="card" />
        <ThreeDsElementsCallout />
      </div>
    </div>
  );
}
